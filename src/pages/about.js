  ...
  return (
    <Layout>
      ...
      <section className="bg-gray-100 lg:text-xl">
        ...
        >
          <div className="black-overlay-2 h-full flex flex-col justify-center items-center bg-gray-900 text-gray-100 font-semibold uppercase">
            <h1 className="mt-32 text-xs lg:text-xl">Lifestyle Photographer in Oudtshoorn</h1>
            <h2 className="mb-8 text-2xl text-center lg:mb-16 lg:text-6xl">My passion is <br /> to see you smiling</h2>
